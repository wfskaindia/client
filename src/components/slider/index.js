  ...
  return (
    <section id={styles.slider}>
      ...
      <label htmlFor={styles.s1} id={styles.slide1}>
        <Image width={100} height={100} src="/images/gallery/1.jpg" alt="" />
      </label>
      <label htmlFor={styles.s2} id={styles.slide2}>
        <Image width={100} height={100} src="/images/gallery/2.jpg" alt="" />
      </label>
      <label htmlFor={styles.s3} id={styles.slide3}>
        <Image width={100} height={100} src="/images/gallery/3.jpg" alt="" />
      </label>
      <label htmlFor={styles.s4} id={styles.slide4}>
        <Image width={100} height={100} src="/images/gallery/4.jpg" alt="" />
      </label>
      <label htmlFor={styles.s5} id={styles.slide5}>
        <Image width={100} height={100} src="/images/gallery/5.jpg" alt="" />
      </label>
      <label htmlFor={styles.s5} id={styles.slide5}>
